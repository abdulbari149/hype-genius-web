	...
	return (
		<div className="flex flex-row justify-between w-full">
			<div className="">
				...
				<p className="text-[#697AFF] text-[17px]">{influencer.email} </p>
				<p className="text-[17px] font-normal">{influencer.phoneNumber}</p>
			</div>

			<div className="space-y-2">
				{!!tag ? <Tag {...tag} className="px-2 ml-auto w-fit" /> : null}

				<div className="flex items-center gap-3">
					<div className="">
						<span className="text-[15px] text-[#21A400] font-[500]">
							${parseFloat(deal?.perVideo.toString(10) ?? '0').toFixed(2)}
						</span>
						/
