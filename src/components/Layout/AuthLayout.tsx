...
const AuthLayout: React.FC<AuthLayoutProps> = ({
	...
	return (
		<div
			className="grid grid-cols-5 h-screen max-w-screen w-full overflow-hidden"
			style={poppins.style}
		>
			<div className="bg-[#EF539E] h-[100%] min-h-screen flex flex-col static col-span-2 py-[100px]">
				...
				<div className="mt-auto mx-auto text-center text-[45px] font-semibold ">
					...
					<p className="text-black rounded-[10px] bg-[#FFDE2E] px-[40px] py-1 w-fit text-center">influencer marketing!</p>
				</div>
			</div>
